...
class ControlSlider extends Control {
    ...
    public function enqueue_js() {
        \wp_enqueue_script( 'toolcool-range-slider', BEAVERCSS_URL . 'js/toolcool-range-slider.min.js', null, BEAVERCSS_VERSION, false );
        \wp_enqueue_script( 'toolcool-binding-labels', BEAVERCSS_URL . 'js/tcrs-binding-labels.min.js', null, BEAVERCSS_VERSION, false );
    }
