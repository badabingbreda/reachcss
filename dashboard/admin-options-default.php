...
<div class="jq-tab-content" data-tab="<?php echo $admin_dashboard_name; ?>">
	<form id="adminoptions-<?php echo $admin_dashboard_name; ?>" action="<?php echo Dashboard::render_form_action( $admin_dashboard_name ); ?>" method="post">
		...
		<p><?php ControlColor::render([ 'value' => 'blue' , 'name' => 'col-action' ] ) ?></p>
		<p><?php ControlSwitch::render([ 'value' => 'blue' , 'target' => '#col-action' , 'classtoggle' => 'disable' , 'name' => 'toggle-nice' ]) ?></p>

		<p class="submit">
						<?php
								ControlSubmit::render( [ 'value' => __('Regenerate CSS', 'toolbox') , 'class' => 'button-primary'  ] );
						?>
